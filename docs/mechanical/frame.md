...
The frame mounts **8 thrusters** in a 3D omnidirectional configuration — 4 top-mounted and 4 bottom-mounted at opposing cant angles. See [Motor Mixing Matrix](../firmware/motor-mixing.md) for the software mapping.
