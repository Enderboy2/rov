...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_VECTORED_6DOF_90DEG:
        ...
        break;
    /* our FUCKING configuration */
    case SUB_FRAME_VECTORED_6DOF:
        _frame_class_string = "VECTORED_6DOF";
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0.071f,           0.2625f,        -0.3335f,         0.525f,        0.7875f,        0.454f,       1); /* Front-Right-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_2,    -0.071f,           0.2625f,         0.3335f,         0.525f,        0.7875f,       -0.454f,       2); /* Front-Left-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0.071f,          -0.2625f,         0.3335f,         0.525f,        0.7875f,        0.454f,       3); /* Rear-Right-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_4,    -0.071f,          -0.2625f,        -0.3335f,         0.525f,        0.7875f,       -0.454f,       4); /* Rear-Left-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_5,    -0.071f,          -0.2625f,        -0.3335f,        -0.525f,        0.7875f,        0.454f,       5); /* Front-Right-Bottom */
        add_motor_raw_6dof(AP_MOTORS_MOT_6,     0.071f,          -0.2625f,         0.3335f,        -0.525f,        0.7875f,       -0.454f,       6); /* Front-Left-Bottom */
        add_motor_raw_6dof(AP_MOTORS_MOT_7,    -0.071f,           0.2625f,         0.3335f,        -0.525f,        0.7875f,        0.454f,       7); /* Rear-Right-Bottom */
        add_motor_raw_6dof(AP_MOTORS_MOT_8,     0.071f,           0.2625f,        -0.3335f,        -0.525f,        0.7875f,       -0.454f,       8); /* Rear-Left-Bottom */
        break;
    ...
    case SUB_FRAME_CUSTOM:
        _frame_class_string = "SUB_FRAME_ENCORE";
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0.071f,           0.2625f,        -0.3335f,         0.525f,        0.7875f,        0.454f,       1); /* Front-Right-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_2,    -0.071f,           0.2625f,         0.3335f,         0.525f,        0.7875f,       -0.454f,       2); /* Front-Left-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0.071f,          -0.2625f,         0.3335f,         0.525f,        0.7875f,        0.454f,       3); /* Rear-Right-Top */
        add_motor_raw_6dof(AP_MOTORS_MOT_4,    -0.071f,          -0.2625f,        -0.3335f,         0.525f,        0.7875f,       -0.454f,       4); /* Rear-Left-Top */
